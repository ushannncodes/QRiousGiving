...
#!/usr/bin/env python3
# cam-final2_ascii_flip.py  (HUD + default polarity=1)
# - Picamera2 capture (no V4L2 timeout)
# - ASCII preview + HUD line under the grid
# - Flip-dot sending via queue + pack_flipbytes
# - Polarity switch: BLACK_IS from FLIP_BLACK_IS (default 1 per your panel)
...
TRIGGER_HOLD_SEC   = float(os.getenv("TRIGGER_HOLD_SEC", "7.0"))
...
# Polarity (per your board requirement)
