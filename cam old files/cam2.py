...
# --- Flipdot update frequency (in seconds) ---
UPDATE_INTERVAL = 0.05  # Flipdots update every 100 ms (~10 fps)
...
def main():
    ...
    try:
        while True:
            ...
            # 2. Process pose and hand detection
            ...
            bw = np.fliplr(bw)  # fix mirror image

            # 5. Update flipdot only if interval has passed
            now = time.time()
            ...
            # 6. Show camera and flipdot preview
